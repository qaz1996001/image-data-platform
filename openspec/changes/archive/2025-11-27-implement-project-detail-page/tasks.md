...
- [x] Verify "Study List" behaves like the main Study Search but filtered by Project. <!-- id: verify-study-list -->
...
- [x] Verify "Report List" allows viewing/searching reports associated with project studies. <!-- id: verify-report-list -->

## 4. Integration & Validation
- [x] Update `ProjectCard` navigation to point to the new detail page structure. <!-- id: update-nav -->
- [x] Validate layout consistency with "Projects" page. <!-- id: validate-layout -->
- [x] E2E Test for Project Detail navigation, tab switching, and list filtering. <!-- id: e2e-test -->
